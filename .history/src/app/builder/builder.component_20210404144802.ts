...
export class BuilderComponent implements OnInit {
  ...
  setDimensions() {
    if (!this.data.dimensions.heat.volume || isNaN(this.data.dimensions.heat.volume)) {
      this.data.dimensions.heat.volume = Config.dimension["heat"].volume;
    }

    Config.dimension["production"].width = parseFloat(this.data.dimensions.production.width);
    Config.dimension["production"].height = parseFloat(this.data.dimensions.production.height);
    Config.dimension["technical"].width = parseFloat(this.data.dimensions.technical.width);
    Config.dimension["technical"].height = parseFloat(this.data.dimensions.technical.height);
    Config.dimension["heat"].volume = parseFloat(this.data.dimensions.heat.volume);
    Config.dimension["steps"].size = parseFloat(this.data.dimensions.steps.size);
    ...
    this.raycaster
      ...
      .forEach((intersect) => {
        if (intersect.object.type == "ground") {
          coords = Object.values(intersect.point);
        }
      });
